...
public class FingerprintAuth extends CordovaPlugin {
    ...
    public boolean execute(final String action,
		...
		final String finalDialogTitle = dialogTitle;
                showFingerprintDialog(Cipher.ENCRYPT_MODE,message, finalDialogTitle);
		...
		dialogTitle = args.getString(2);
            ...
            if (isFingerprintAuthAvailable()) {
                ...
                if (secretKey != null) {
                    mKeyID = key;
		    final String finalDialogTitle = dialogTitle;
                    showFingerprintDialog(Cipher.DECRYPT_MODE,message, finalDialogTitle);
    ...
    public void showFingerprintDialog(final int mode, final String message, final String dialogTitle){
